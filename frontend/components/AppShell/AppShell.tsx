...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="w-full max-w-[1240px] bg-[var(--surface)] border border-[var(--line-2)] shadow-[0_1px_3px_rgba(20,35,27,0.05),0_10px_34px_rgba(20,35,27,0.045)]">
      ...
      <div className={`grid max-[900px]:flex max-[900px]:flex-col transition-[grid-template-columns] duration-[220ms] ease-in-out ${collapsed ? "grid-cols-[56px_minmax(0,1fr)]" : "grid-cols-[216px_minmax(0,1fr)]"}`}>
        ...
        <main className="min-w-0 flex flex-col max-[900px]:pb-[70px]">{children}</main>
      </div>
    </div>
  );
}
