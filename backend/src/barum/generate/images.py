...
- **벽·콘크리트·돌·시멘트·석고처럼 차갑고 칙칙한 표면은 배경으로 쓰지 마라.**
  화장품 상세페이지답게 위 컬러톤에 맞춰 화사하고 밝고 촉촉한 분위기를 유지하라
...
_COMPOSITION_BY_LAYOUT_TYPE_TEMPLATES: dict[str, str] = {
    ...
    # 서로 겹치지 않게 채운다.
    "section_statement": (
        "- 이 유형은 어휘집상 '강한 피사체 없이 차분한 배경면'이다. 위 컬러톤에 맞춘\n"
        "  **밝고 화사한 배경**을 그려라: 부드러운 새틴·실크 천의 흐름, 은은한 보케\n"
        "  빛망울, 물방울 맺힌 촉촉한 표면, 흩어진 꽃잎의 소프트포커스 정물 정도.\n"
        "  강한 주제 피사체는 넣지 말되, **벽·석고·콘크리트·돌·시멘트처럼 차갑고 칙칙한\n"
        "  표면은 절대 그리지 마라.** 화장품 상세페이지답게 화사하고 촉촉한 분위기여야 한다.\n"
        "  **제형 질감 클로즈업은 그리지 마라**(그건 mood_macro 카드 몫이다)"
    ),
    "card_list_repeat": (
...
_DEFAULT_COMPOSITION = (
    "- 위 컬러톤에 맞춘 밝고 화사한 배경을 그려라: 이 제품 제형의 질감 클로즈업({hint}),\n"
    "  또는 부드러운 빛·흩어진 꽃잎·새틴·물방울 위주의 화사한 정물.\n"
    "- **벽·석고·콘크리트·돌·시멘트처럼 거칠고 칙칙한 표면은 그리지 마라.**"
)
